...
func log(_ msg: String) { AppLog.shared.append("[ExternalNoelx] \(msg)") }
...
enum AppUpdateChecker {
    ...
    static let apiURL = URL(string: "https://api.github.com/repos/Noelxi/ExternalNoelx/releases/latest")!
    static let fallbackURL = URL(string: "https://github.com/Noelxi/ExternalNoelx/releases/latest")!
    ...
    static func check() async -> Offer? {
        ...
        request.setValue("External Noelx", forHTTPHeaderField: "User-Agent")
